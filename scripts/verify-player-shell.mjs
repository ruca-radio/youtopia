...
assertIncludes("src/main/integrations/companion-server/index.ts", 'autoplay playsinline src="/tv/program"');
...
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"anullsrc=channel_layout=stereo:sample_rate=48000"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "amix=inputs=2");
