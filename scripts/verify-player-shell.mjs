...
assertIncludes("src/main/integrations/lightss/index.ts", '"song" | "audioProfile" | "audioSignals"');
assertIncludes("src/main/integrations/lightss/index.ts", "const audioSignals = this.buildWledAudioSignals(audioProfile);");
assertIncludes("src/main/integrations/lightss/index.ts", "audioSignals,");
assertIncludes("src/main/integrations/lightss/index.ts", "audioSignals.compactBins");
...
assertIncludes("src/main/integrations/companion-server/index.ts", "led-sample-overlay");
assertIncludes("src/main/integrations/companion-server/index.ts", "data-led-sample");
assertIncludes("src/main/integrations/companion-server/index.ts", "applyLedSample");
...
assertIncludes("src/main/integrations/companion-server/index.ts", 'const allowed = ["playPause", "previous", "next", "seekBackward", "seekForward"]');
...
assertIncludes("src/main/integrations/companion-server/index.ts", "sanitizeFusionHtml");
assertIncludes("src/main/integrations/companion-server/index.ts", "applyFusionHtml");
assertIncludes("src/main/integrations/companion-server/index.ts", "postFusionPlayerState");
assertNotIncludes("src/main/integrations/companion-server/index.ts", 'const flashUiHtml = ""; // Scrap fusion for right now');
assertIncludes("src/assets/flash-ui-dist/index.html", "Youtopia Fusion Studio");
assertIncludes("src/assets/flash-ui-dist/index.html", "fusionPreview");
assertIncludes("src/assets/flash-ui-dist/index.html", "/tv/events");
assertIncludes("src/assets/flash-ui-dist/index.html", "postFusionPlayerState");
assertIncludes("src/assets/flash-ui-dist/index.html", "audioBins");
assertIncludes("src/main/integrations/companion-server/index.ts", "Fusion Studio");
assertIncludes("src/renderer/windows/main/player-shell/CommandTopBar.vue", 'label="Fusion Studio"');
assertIncludes("src/renderer/windows/main/player-shell/TwoLevelTopBar.vue", 'label="Fusion Studio"');
assertNotIncludes("src/main/integrations/companion-server/index.ts", "window.GEMINI_API_KEY");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "scriptInject");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "getGeminiApiKey");
assertNotIncludes("src/assets/flash-ui-dist/index.html", "Diffusion Chat");
assertNotIncludes("src/assets/flash-ui-dist/index.html", "@google/genai");
assertNotIncludes("src/assets/flash-ui-dist/index.html", "created by @ammaar");
assertNotIncludes("src/assets/flash-ui-dist/index.html", "Surprise Me");
...
assertIncludes("src/renderer/windows/main/Index.vue", "fusionHtml");
assertIncludes("src/renderer/windows/main/Index.vue", ':fusion-html="fusionHtml"');
...
assertIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "fusionHtml");
assertIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "postFusionPlayerState");
assertIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "handleFusionControlMessage");
assertIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "youtopiaControl");
assertIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "srcdoc");
assertNotIncludes("src/renderer/windows/main/player-shell/FullscreenVuPlayer.vue", "Scrap fusion for right now");

assertIncludes("src/main/integrations/lightss/index.ts", "Model-owned TV UX");
assertIncludes("src/main/integrations/lightss/index.ts", "Core TV UX requirements");
assertIncludes("src/main/integrations/lightss/index.ts", "play/pause, previous, next, rewind, and fast-forward");
assertIncludes("src/main/integrations/lightss/index.ts", "window.parent.postMessage");
assertIncludes("src/main/integrations/lightss/index.ts", "youtopiaControl");
assertIncludes("src/main/integrations/lightss/index.ts", "Create your own layout");
assertIncludes("src/main/integrations/lightss/index.ts", "audioBins");
assertNotIncludes("src/main/integrations/lightss/index.ts", "Split-Screen Dashboard Layout");
assertNotIncludes("src/main/integrations/lightss/index.ts", "Left Pane");
assertNotIncludes("src/main/integrations/lightss/index.ts", "Right Pane");
assertNotIncludes("src/main/integrations/lightss/index.ts", "Interactive Queue List");

assertIncludes("src/main/integrations/companion-server/index.ts", "handleFusionControlMessage");
assertIncludes("src/main/integrations/companion-server/index.ts", "youtopiaControl");
assertIncludes("src/main/integrations/companion-server/index.ts", "seekBackward");
assertIncludes("src/main/integrations/companion-server/index.ts", "seekForward");
assertIncludes("src/main/index.ts", "seekRelative");
assertIncludes("src/renderer/ytmview/preload.ts", "seekRelative");
assertIncludes("firetv-receiver/src/main/java/studio/youtopia/tvreceiver/MainActivity.java", 'sendControl("seekForward")');
assertIncludes("firetv-receiver/src/main/java/studio/youtopia/tvreceiver/MainActivity.java", 'sendControl("seekBackward")');
