...
assertIncludes("src/main/integrations/lightss/index.ts", "buildCollaborativeAgentBriefing");
assertIncludes("src/main/integrations/lightss/index.ts", "Shared agent briefing");
assertIncludes("src/main/integrations/lightss/index.ts", "agentCollaboration");
assertIncludes("src/main/integrations/lightss/index.ts", "waitForFreshAudioProfile");
assertIncludes("src/main/integrations/lightss/index.ts", "buildWledAudioSignals");
assertIncludes("src/main/integrations/lightss/index.ts", "audioSignals");
assertIncludes("src/main/integrations/lightss/index.ts", "Use audioSignals.live, energy, bass, mid, treble, dominantBand, and compactBins");
assertIncludes("src/main/integrations/lightss/index.ts", "buildWledControllerContext");
assertIncludes("src/main/integrations/lightss/index.ts", "wledController");
assertIncludes("src/main/integrations/lightss/index.ts", "safeEffectNames");
assertIncludes("src/main/integrations/lightss/index.ts", "audioReactive");
assertIncludes("src/main/integrations/lightss/index.ts", "Use wledController.currentState, safeEffectNames, safePaletteNames");
assertIncludes("src/main/integrations/lightss/index.ts", "AI ticker stage");
assertIncludes("src/main/integrations/lightss/index.ts", "buildSafeFallbackPlan");
assertIncludes("src/main/integrations/lightss/index.ts", "Sketch fallback plan");
assertIncludes("src/main/integrations/lightss/index.ts", "Full fallback plan");
assertIncludes("src/main/integrations/lightss/index.ts", "Safe fallback plan applied");
assertIncludes("src/main/integrations/lightss/index.ts", "sanitizeGeminiResponseSchema");
assertIncludes("src/main/integrations/lightss/index.ts", "image_url: imageUrl");
...
assertIncludes("src/main/integrations/companion-server/index.ts", 'this.fastifyServer.get("/tv/program.m3u8"');
assertIncludes("src/main/integrations/companion-server/index.ts", 'this.fastifyServer.get("/tv/program-hls/:file"');
assertIncludes("src/main/integrations/companion-server/index.ts", 'this.fastifyServer.get("/tv/program-receiver"');
...
assertIncludes("src/main/integrations/companion-server/index.ts", "meter-stage");
assertIncludes("src/main/integrations/companion-server/index.ts", "ai-stage");
assertIncludes("src/main/integrations/companion-server/index.ts", "ai-stage-copy");
assertIncludes("src/main/integrations/companion-server/index.ts", "buildAiStageText");
assertIncludes("src/main/integrations/companion-server/index.ts", "animationDuration = Math.max(18");
...
assertIncludes("src/main/integrations/companion-server/index.ts", 'autoplay playsinline src="/tv/program.m3u8"');
assertIncludes("src/main/integrations/companion-server/index.ts", "application/vnd.apple.mpegurl");
assertIncludes("src/main/integrations/companion-server/index.ts", "video/mp2t");
assertIncludes("src/main/integrations/companion-server/index.ts", "Server output live: audio and video in one feed");
assertIncludes("src/main/integrations/companion-server/index.ts", "window.youtopiaTvControl");
assertIncludes("src/main/integrations/companion-server/index.ts", "sendProgramControl");
assertIncludes("src/main/integrations/companion-server/index.ts", 'const allowed = ["playPause", "previous", "next"]');
assertIncludes("src/main/integrations/companion-server/index.ts", "program.play().catch");
assertIncludes("src/main/integrations/companion-server/index.ts", "restartProgramStream");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "Reload program");
assertNotIncludes("src/main/integrations/companion-server/index.ts", 'id="reload"');
...
assertNotIncludes("src/main/integrations/companion-server/index.ts", "Decrease audio delay");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "Increase audio delay");
assertNotIncludes("src/main/integrations/companion-server/index.ts", 'id="audioResync"');
assertNotIncludes("src/main/integrations/companion-server/index.ts", "audioResync");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "audioDelayDown");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "audioDelayUp");
...
assertNotIncludes("src/main/integrations/companion-server/index.ts", "audioDelayMs");
assertIncludes("src/main/integrations/companion-server/index.ts", "activeTvAudioStop");
assertNotIncludes("src/main/integrations/companion-server/index.ts", "scheduleDelayedAudioConnect");
...
assertIncludes("src/main/integrations/companion-server/index.ts", 'audioConnect.addEventListener("click", connectTvAudio);');
...
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "export function ensureTvProgramHlsStream");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "video/mp4");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"-f",');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"hls"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"/tv/program-hls/"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "selectTvProgramVideoEncoder");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"h264_nvenc"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"libx264"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"frag_keyframe+empty_moov+default_base_moof"');
assertNotIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"anullsrc=channel_layout=stereo:sample_rate=48000"');
assertNotIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "amix=inputs=2");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "buildTvProgramAudioFilter");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "volume=8dB");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "dynaudnorm=");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "alimiter=limit=0.92");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"color=c=black:s=1280x720:r=30"');
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "showwaves=s=1080x220");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "drawbox=x=58:y=276:w=1164:h=252");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "drawbox=x=92:y=398:w=1096:h=2");
assertIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", "SERVER HLS");
...
assertNotIncludes("src/main/integrations/companion-server/tv-audio-stream.ts", '"libvpx"');
...
assertIncludes(audioAnalyzer, "makeupGainNode");
assertIncludes(audioAnalyzer, "FM-style makeup gain");
assertIncludes(audioAnalyzer, "compressorNode.connect(makeupGainNode)");
assertIncludes(audioAnalyzer, "zeroFrameCount");
assertIncludes(audioAnalyzer, "ZERO_FRAME_REBUILD_THRESHOLD");
